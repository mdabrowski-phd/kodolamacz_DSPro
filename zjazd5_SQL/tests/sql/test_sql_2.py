...
class TestSql:
    ...
    def test_load_passengers_and_their_cabin_numbers_keep_passengers_without_tickets(self, load_titanic_data):
        ...
        """
        df = run_query("SELECT Name, Cabin FROM passengers LEFT OUTER JOIN tickets "
                       "ON passengers.PassengerID = tickets.PassengerID")
    ...
    def test_load_passengers_and_their_ticket_numbers_remove_passengers_without_tickets(self, load_titanic_data):
        ...
        """
        df = run_query("SELECT Name, Ticket FROM passengers p INNER JOIN tickets t ON p.PassengerID = t.PassengerID")
